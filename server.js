...
const config = {
  user: '', //Input username used in SQL Management Studio.
  password: '', //Input password for said username in SQL Management Studio.
  server: '', //Input server name used during login in SQL Management Studio.
  database: 'ITFITS', 
  options: {
    encrypt: true,
